...
const SECTIONS = [
    ...
    fields: [
      {
        ...
        dropdown: ["weekly", "bi-weekly", "semi-monthly", "monthly"],
      },
      {
        key: "payday",
        label: "Payday",
        unit: "",
        hint: "Which day of the week you get paid",
        dropdown: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
      },
      {
        key: "paycheckStandard",
        label: "Standard Paycheck",
        unit: "$",
        hint: "Typical take-home pay per paycheck after taxes",
        dropdown: null,
      },
      {
        key: "paycheckFirstOfMonth",
        label: "First-of-Month Paycheck",
        unit: "$",
        hint: "Leave blank if same as standard (e.g. benefits deducted)",
        dropdown: null,
      },
      {
        key: "isContractor",
        ...
        unit: "",
        hint: "Enables quarterly tax estimate tracking",
        dropdown: ["true", "false"],
      },
    ],
  },
  {
    ...
    fields: [
      {
        key: "weeklySpendAllowance",
        label: "Weekly Spend Allowance",
        unit: "$",
        hint: "Target max spending per week (excluding bills)",
        dropdown: null,
      },
      {
        key: "emergencyFloor",
        ...
        unit: "$",
        hint: "Minimum checking balance you never want to go below",
        dropdown: null,
      },
      {
        key: "checkingBuffer",
        ...
        unit: "$",
        hint: "Comfortable buffer above your emergency floor",
        dropdown: null,
      },
      {
        key: "greenStatusTarget",
        label: "Green Status Target",
        unit: "$",
        hint: "Checking balance that means you are in great shape",
        dropdown: null,
      },
      {
        key: "emergencyReserveTarget",
        label: "Emergency Reserve Target",
        unit: "$",
        hint: "Savings goal for your emergency fund",
        dropdown: null,
      },
      {
        key: "defaultAPR",
        label: "Default APR",
        unit: "%",
        hint: "Used to estimate interest on unpaid card balances",
        dropdown: null,
      },
      {
        key: "arbitrageTargetAPR",
        label: "Arbitrage Target APR",
        unit: "%",
        hint: "Target APR for balance transfer / arbitrage",
        dropdown: null,
      },
    ],
  },
  {
    ...
    fields: [
      {
        key: "heavyHorizonStart",
        label: "Heavy Horizon Start",
        unit: "days",
        hint: "Days before payday where spending is scrutinized more",
        dropdown: null,
      },
      {
        key: "heavyHorizonEnd",
        label: "Heavy Horizon End",
        unit: "days",
        hint: "End of heavy horizon window",
        dropdown: null,
      },
      {
        key: "heavyHorizonThreshold",
        label: "Heavy Horizon Threshold",
        unit: "$",
        hint: "Checking balance that triggers heavy horizon mode",
        dropdown: null,
      },
    ],
  },
  {
    ...
    fields: [
      {
        key: "trackVapes",
        label: "Track Vape Usage",
        unit: "",
        hint: "Enable vape usage tracking",
        dropdown: ["true", "false"],
      },
      {
        key: "vapeCheckThreshold",
        label: "Vape Check Threshold",
        unit: "",
        hint: "Number of vapes remaining that triggers a warning",
        dropdown: null,
      },
      {
        key: "vapeCriticalThreshold",
        label: "Vape Critical Threshold",
        unit: "",
        hint: "Number of vapes remaining that triggers critical alert",
        dropdown: null,
      },
      {
        key: "vapeUsageRate",
        label: "Vape Usage Rate (per day)",
        unit: "",
        hint: "Average vapes consumed per day",
        dropdown: null,
      },
    ],
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        unit: "$",
        hint: "Current Roth IRA account balance",
        dropdown: null,
      },
      {
        key: "rothAnnualLimit",
        label: "Roth Annual Contribution Limit",
        unit: "$",
        hint: "IRS limit for the year (e.g. 7000)",
        dropdown: null,
      },
      {
        key: "rothContributedYTD",
        label: "Roth Contributed YTD",
        unit: "$",
        hint: "How much you have contributed so far this year",
        dropdown: null,
      },
      {
        key: "rothStockPct",
        label: "Roth Stock Allocation",
        unit: "%",
        hint: "Equity allocation percentage (e.g. 90)",
        dropdown: null,
      },
    ],
  },
  {
    ...
    fields: [
      ...
      {
        key: "k401AnnualLimit",
        label: "401(k) Annual Contribution Limit",
        unit: "$",
        hint: "IRS limit for the year (e.g. 23000)",
        dropdown: null,
      },
      {
        key: "k401ContributedYTD",
        label: "401(k) Contributed YTD",
        unit: "$",
        hint: "How much you have contributed so far this year",
        dropdown: null,
      },
      {
        key: "k401EmployerMatchPct",
        label: "Employer Match",
        unit: "%",
        hint: "Employer matches X% of your contributions (e.g. 50)",
        dropdown: null,
      },
      {
        key: "k401EmployerMatchLimit",
        label: "Employer Match Ceiling",
        unit: "%",
        hint: "Up to X% of your salary (e.g. 6)",
        dropdown: null,
      },
      {
        key: "k401VestingPct",
        label: "Vesting",
        unit: "%",
        hint: "How much of matched funds are yours today (e.g. 100)",
        dropdown: null,
      },
      {
        key: "k401StockPct",
        label: "401(k) Stock Allocation",
        unit: "%",
        hint: "Equity allocation percentage (e.g. 90)",
        dropdown: null,
      },
  ...
  },
  {
    ...
    fields: [
      {
        key: "trackBrokerage",
        label: "Track Brokerage",
        unit: "",
        hint: "Enable taxable brokerage tracking",
        dropdown: ["true", "false"],
      },
      {
        key: "investmentBrokerage",
        label: "Brokerage Balance",
        unit: "$",
        hint: "Current taxable brokerage account balance",
        dropdown: null,
      },
      {
        key: "brokerageStockPct",
        label: "Brokerage Stock Allocation",
        unit: "%",
        hint: "Equity allocation percentage (e.g. 90)",
        dropdown: null,
      },
    ...
    fields: [
      {
        ...
        label: "Credit Score",
        unit: "",
        hint: "Your current FICO score (e.g. 750)",
        dropdown: null,
      },
      {
        key: "creditScoreDate",
        ...
        unit: "",
        hint: "Date of last check — format: YYYY-MM-DD",
        dropdown: null,
      },
      {
        ...
        unit: "%",
        hint: "Current overall credit utilization percentage",
        dropdown: null,
      },
    ],
  },
    ...
    fields: [
      {
        ...
        unit: "%",
        hint: "Effective tax withholding rate (e.g. 22)",
        dropdown: null,
      },
      {
        key: "quarterlyTaxEstimate",
        label: "Quarterly Tax Estimate",
        unit: "$",
        hint: "Estimated quarterly tax payment if self-employed",
        dropdown: null,
      },
    ],
  },
  {
    ...
    fields: [
      ...
      { key: "vehicleValue", label: "Vehicle Value", unit: "$", hint: "Estimated vehicle value", dropdown: null },
      {
        ...
        label: "Other Assets",
        unit: "$",
        hint: "Value of other significant assets",
        dropdown: null,
      },
      {
        key: "otherAssetsLabel",
        label: "Other Assets Label",
        unit: "",
        hint: "Description of other assets (e.g. Rental Property)",
        dropdown: null,
      },
    ],
  },
