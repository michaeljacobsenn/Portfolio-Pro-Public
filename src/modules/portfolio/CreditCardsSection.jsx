...
export default function CreditCardsSection() {
    ...
    const [collapsedSections, setCollapsedSections] = useState({ creditCards: false });
            ...
            >
                ...
                <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 8 }}>
                    <Badge
                        ...
                        style={{
                            fontSize: 10,
                            color: cards.length > 0 ? T.accent.primary : T.text.muted,
                            borderColor: cards.length > 0 ? `${T.accent.primary}40` : T.border.default,
                        }}
                    >
                        {cards.length}
                    </Badge>
                                                    ...
                                                    {editingCard === card.id ? (
                                                        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                                                            ...
                                                            {(() => {
                                                                const tabs = [
                                                                    {
                                                                        label: "Card",
                                                                        filled: !!(editForm.institution || editForm.name || editForm.limit),
                                                                    },
                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        {tabs.map((tab, idx) => (
                                                                            ...
                                                                            >
                                                                                {tab.filled && editStep !== idx && (
                                                                                    <CheckCircle2 size={9} style={{ opacity: 0.6 }} />
                                                                                )}
                                                                                {tab.label}
                                                                            </button>
                                                                        ))}
                                                                    ...
                                                                    <div style={{ display: "flex", gap: 8 }}>
                                                                        ...
                                                                        <SearchableSelect
                                                                            ...
                                                                            options={(() => {
                                                                                ...
                                                                                const pinnedItems = list.filter(
                                                                                    c => pinnedSet.has(c.name.toLowerCase()) && c.status !== "discontinued"
                                                                                );
                                                                                const restActive = list
                                                                                    .filter(
                                                                                        c => !pinnedSet.has(c.name.toLowerCase()) && c.status !== "discontinued"
                                                                                    )
                                                                    ...
                                                                    <div style={{ display: "flex", gap: 8 }}>
                                                                        <div style={{ flex: 1, position: "relative" }}>
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                style={{ paddingLeft: 28, fontFamily: T.font.mono, fontWeight: 600 }}
                                                                            />
                                                                        </div>
                                                                        <div style={{ flex: 1 }}>
                                                                            <input
                                                            ...
                                                            {editStep === 1 && (
                                                                <>
                                                                    ...
                                                                    <div style={{ display: "flex", gap: 8 }}>
                                                                        <div style={{ flex: 0.5, position: "relative" }}>
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                onChange={e => setEditForm(p => ({ ...p, annualFee: e.target.value }))}
                                                                        ...
                                                                        <div style={{ flex: 0.5, position: "relative" }}>
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                onChange={e => setEditForm(p => ({ ...p, annualFeeDue: e.target.value }))}
                                                                                aria-label="Annual fee due date"
                                                                                style={{
                                                                                    width: "100%",
                                                                    ...
                                                                    <div style={{ marginTop: -4, paddingLeft: 4 }}>
                                                                        <WaivedCheckbox
                                                                            checked={editForm.annualFeeWaived}
                                                                            onChange={() =>
                                                                                setEditForm(p => ({ ...p, annualFeeWaived: !p.annualFeeWaived }))
                                                                            }
                                                                        />
                                                                    </div>
                                                                    <div style={{ display: "flex", gap: 8 }}>
                                                                        <div style={{ flex: 1, position: "relative" }}>
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                pattern="[0-9]*"
                                                                                value={editForm.apr}
                                                                                onChange={e => setEditForm(p => ({ ...p, apr: e.target.value }))}
                                                                                placeholder="Standard APR (%)"
                                                                                aria-label="Standard APR percentage"
                                                                                style={{
                                                                                    width: "100%",
                                                                    ...
                                                                    <div style={{ marginTop: -4, paddingLeft: 4 }}>
                                                                        <PromoCheckbox
                                                                            checked={editForm.hasPromoApr}
                                                                            onChange={() => setEditForm(p => ({ ...p, hasPromoApr: !p.hasPromoApr }))}
                                                                        />
                                                                    </div>
                                                                        ...
                                                                        <div style={{ display: "flex", gap: 8, marginTop: -4 }}>
                                                                            <div style={{ flex: 0.5, position: "relative" }}>
                                                                                ...
                                                                                <input
                                                                                    ...
                                                                                    inputMode="decimal"
                                                                                    pattern="[0-9]*"
                                                                                    value={editForm.promoAprAmount}
                                                                                    onChange={e => setEditForm(p => ({ ...p, promoAprAmount: e.target.value }))}
                                                                                    placeholder="Promo APR"
                                                                                    aria-label="Promo APR percentage"
                                                                                    style={{
                                                                                        width: "100%",
                                                                                        padding: "10px 24px 10px 10px",
                                                                                        borderRadius: T.radius.md,
                                                                            ...
                                                                            <div style={{ flex: 0.5, position: "relative" }}>
                                                                                ...
                                                                                <input
                                                                                    type="date"
                                                                                    value={editForm.promoAprExp}
                                                                                    onChange={e => setEditForm(p => ({ ...p, promoAprExp: e.target.value }))}
                                                                                    aria-label="Promo APR expiration date"
                                                                                    style={{
                                                                                        width: "100%",
                                                                                        padding: "20px 10px 6px 10px",
                                                                                        borderRadius: T.radius.md,
                                                                    ...
                                                                    <div style={{ display: "flex", gap: 6 }}>
                                                                        <div style={{ flex: 1 }}>
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                min="1"
                                                                                max="31"
                                                                                value={editForm.statementCloseDay}
                                                                                onChange={e =>
                                                                                    setEditForm(p => ({ ...p, statementCloseDay: e.target.value }))
                                                                                }
                                                                                placeholder="Day"
                                                                                aria-label="Statement close day"
                                                                                style={{
                                                                                    width: "100%",
                                                                                    padding: "8px 10px",
                                                                                    borderRadius: T.radius.md,
                                                                        ...
                                                                        <div style={{ flex: 1 }}>
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                onChange={e => setEditForm(p => ({ ...p, paymentDueDay: e.target.value }))}
                                                                                placeholder="Day"
                                                                        ...
                                                                        <div style={{ flex: 1, position: "relative" }}>
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                onChange={e => setEditForm(p => ({ ...p, minPayment: e.target.value }))}
                                                                                placeholder="35"
                                                        ...
                                                        >
                                                            <div style={{ flex: 1, minWidth: 0 }}>
                                                                ...
                                                                >
                                                                    {getCardLabel(cards, card).replace(inst + " ", "")}
                                                                </span>
                                                                <Mono
                                                                    size={10}
                                                                    color={T.text.dim}
                                                                    style={{ display: "block", marginTop: 3, lineHeight: 1.4 }}
                                                                >
                                                                    {[
                                                                        card.annualFee > 0 &&
                                                                        (card.annualFeeWaived
                                                                            ? "AF waived"
                                                                            : `AF ${fmt(card.annualFee)}${card.annualFeeDue ? ` · ${card.annualFeeDue}` : ""}`),
                                                            ...
                                                            <div style={{ display: "flex", alignItems: "center", gap: 6, flexShrink: 0 }}>
                                                                <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end" }}>
                                                                    {card._plaidBalance != null && (
                                                                        <Mono size={14} weight={900} color={T.status.red}>
                                                                            {fmt(card._plaidBalance)}
                                                                        </Mono>
                                                                    )}
                                                                    <Mono
                                                                        size={card._plaidBalance != null ? 10 : 13}
                                                                        weight={700}
                                                                        color={card._plaidBalance != null ? T.text.dim : colors.text}
                                                                    >
                                                                        {card._plaidBalance != null ? "Limit " : ""}
                                                                        {fmt(card.limit)}
                                                                    </Mono>
                                                                </div>
                                                                <button
