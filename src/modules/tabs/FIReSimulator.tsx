...
function calculateFIRE(netWorth: number, income: number, expenses: number, withdrawalRatePct: number, expectedReturnPct: number): FireResult {
...
export default function FIReSimulator({ currentNetWorth = 0, annualIncome = 0, annualExpenses = 0 }: FIReSimulatorProps) {
